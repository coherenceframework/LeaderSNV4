// ════════════════════════════════════════════════════════════════
// LEADER COHERENCE SNAPSHOT — CONTENT ASSEMBLY ENGINE v5
// Vercel Serverless Function (api/assemble.js)
// Zero-amplitude patch integrated.
// v8 scoring engine: defining_flag, breadth_override, buildPortraitFrame return fix,
//   PORTRAIT_FRAME_SUBTYPE, SEC01/SEC10 COHERENT updates.
// ════════════════════════════════════════════════════════════════
...
const GAP_BEING = {
  ...
  "Drifting": `Your internal integrity is losing structural coherence. The relationship between you and your own truth has become unreliable. The signal from your core is breaking up — you sense something but cannot consistently distinguish it from noise or interference. This is not confusion about external circumstances. It is a loss of contact with the internal reference point that should orient everything else. When Being drifts, every other territory operates without a stable foundation. What you build and how you relate may still function — but they are functioning on ground that is shifting beneath them.`,
...
const GAP_RELATING = {
  "Coherent": `In the field between you and others — the people, systems, and conditions you operate within — truth is moving freely. What you sense in a conversation, you can name. What others need to tell you, they do. The relational field is not frictionless — but the friction that exists is being processed in the moment rather than accumulating as unspoken weight. Feedback reaches you. Disagreement is possible without cost. The gap between what is known and what can be said is small enough that the signal from your core passes through without significant distortion.`,
  "Driven": `In the field between you and others, things are moving — but they are being managed on the way through. The people around you are receiving a version of you that is functional and responsive, but it costs energy to maintain that version. What you are not saying may be more significant than what you are. The signal from your core is arriving in the relational space but the adapted self is editing it before it reaches the surface — deciding what is safe to share, what would create disruption, what is better held. This is not deception. It is management. And it is so effective that the people around you may not know they are receiving a filtered signal.`,
...
function assembleReport(v) {
  ...
  let sec01 = isZeroAmp ? SEC01_ZERO_AMP : (SEC01[state] || "");
